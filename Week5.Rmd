...
First, I'm going to add in an independent variable to try for a better model fit. I'm doing this at the recommendation of Catherine. I think it will be meaningful to add in Household Income. We can see that as your household income increases by $1, you pay 0.0001 percentage points less of your income on rent. This is statistically significant. By adding in this independant variable, my Multiple R-squared value increased from 0.036 to 0.247. I will keep this additional variable in further studies.
...
Maybe the percentage of income you pay on rent relates to age in more of a step-wise than a linear way because very young people in Suffolk County (25 years or younger) are spending a larger percentage of their income on rent. When I change AGEP to a categorical variable, we see that people 25 years or younger spend 2.68 percentage points of their income more on rent, as compared to people older than 25 and controlling for all other variables. 

My multiple R-squared value went from 0.247 to 0.248, so no major change there.
...
Finally, let's add an interaction term. These past couple of weeks, I'm been hypothesizing that Race (independent variable) has an effect on Education Level (other independent variable). This could be related to systemic racial inequalities in the U.S. education system, especially higher education. Here I will try to capture that effect.
