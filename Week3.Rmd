...
This correlation is only moderately (around 0.5) but statistically significant. There is a negative correlation at a 95% confidence level. 
...
This correlation is moderately weak (around 0.3) and statistically significant. There is a negative correlation at a 95% confidence level. 
...
There is a significant relationship between these two variables. We can be 95% confident that people in this sample set with a four-year college degree (Bachelor's or higher) live in households that pay 5% - 6% less of their income on rent than those without a Bachelor's degree. This is statistically significant. It looks like many people with a college degree live in households that pay less than 20% of their income on rent.
...
There is a significant relationship between these two variables. We can be 95% confident that households with at least one person who is white that pay 2% - 3% less of their income on rent than non-white households. This is statistically significant. Again, many more household with at least one white person pay less than 20% of their income on rent.
...
For this data set of residents of Suffolk County, is there a relationship between an individuals race and their education level?
...
There is a statistically significant relationship between an individual's race and their level of education. There is weak confidence that there is a relationship between an individual's race and their level of education in this sample set. 
